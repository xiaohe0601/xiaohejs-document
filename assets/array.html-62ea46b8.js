import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as i,c as l,a as n,b as s,d as t,e}from"./app-d69b7adf.js";const r={},c={class:"hint-container info"},d=n("p",{class:"hint-container-title"},"相关信息",-1),u=n("p",null,"作者：小何同学",-1),m=n("h3",{id:"arrayutils-flat2tree",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#arrayutils-flat2tree","aria-hidden":"true"},"#"),s(" ArrayUtils.flat2tree")],-1),k=e(`<h4 id="参数" tabindex="-1"><a class="header-anchor" href="#参数" aria-hidden="true">#</a> 参数</h4><ul><li><p><code>[array]</code> (any[])：扁平数组</p></li><li><p><code>[options]</code> (<a href="#iarrayutilsflat2treeoptions">IArrayUtilsFlat2TreeOptions</a>)：配置项</p></li></ul><h4 id="类型" tabindex="-1"><a class="header-anchor" href="#类型" aria-hidden="true">#</a> 类型</h4><h5 id="iarrayutilsflat2treeoptions" tabindex="-1"><a class="header-anchor" href="#iarrayutilsflat2treeoptions" aria-hidden="true">#</a> IArrayUtilsFlat2TreeOptions</h5><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>可选值</th><th>默认值</th></tr></thead><tbody><tr><td>key</td><td>节点唯一标识属性名</td><td>string</td><td>-</td><td>id</td></tr><tr><td>parentKey</td><td>父节点唯一标识属性名</td><td>string</td><td>-</td><td>pid</td></tr><tr><td>processor</td><td>节点数据处理器</td><td>(item: T) =&gt; T</td><td>-</td><td><code>(item) =&gt; (item)</code></td></tr></tbody></table><h4 id="返回" tabindex="-1"><a class="header-anchor" href="#返回" aria-hidden="true">#</a> 返回</h4><p><code>T[]</code>：树形结构数组</p><details class="hint-container details"><summary>使用示例（点击展开查看）</summary><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> array <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details>`,6);function y(h,q){const a=o("badge");return i(),l("div",null,[n("div",c,[d,n("p",null,[s("Since："),t(a,{text:"0.0.4",vertical:"middle"})]),u]),m,t(a,{text:"0.0.4",vertical:"middle"}),s(" 扁平数组转树形结构数组"),k,t(a,{text:"0.0.4",vertical:"middle"}),s(" 树形结构数组转扁平数组"),v,t(a,{text:"0.0.4",vertical:"middle"}),s(" 递归遍历树形结构数组"),b])}const _=p(r,[["render",y],["__file","array.html.vue"]]);export{_ as default};
